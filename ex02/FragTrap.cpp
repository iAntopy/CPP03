...
void	FragTrap::highFivesGuys(void)
{
	...
	{
		std::cout << _name << ", hanging out with friends, asks for a round of high fives. Their enthusiastic friends raise their arms ready for the celebration. Tragically, while trying to raise their own arm, " << _name << " remembers they are too tired to raise their arm. Too ashamed to admit they cannot possibly fulfill this social contract they brought about themselves, " << _name << " settled on creating a little subterfuge. \"Hey look, isn't that Shia Labeouf overthere\" they exclamed while looking at a distant crowd of tourists. The group of friends now looking for their idol, " << _name << " takes whatever energy they have left to hop on the back of a passing juggling monocyclist and escape this unfortunate situation unnoticed. HOORAY " << _name << " WINS !" << std::endl;
		return ;
	}
